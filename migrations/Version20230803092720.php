 ...
 */
final class Version20230803092720 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE eleves (id INT AUTO_INCREMENT NOT NULL, nom_id INT NOT NULL, prenom_id INT NOT NULL, lieu_naissance_id INT NOT NULL, statut_id INT NOT NULL, departement_id INT NOT NULL, classe_id INT NOT NULL, ecole_an_dernier_id INT DEFAULT NULL, ecole_recrutement_id INT NOT NULL, scolarite1_id INT DEFAULT NULL, scolarite2_id INT DEFAULT NULL, scolarite3_id INT DEFAULT NULL, redoublement1_id INT DEFAULT NULL, redoublement2_id INT DEFAULT NULL, redoublement3_id INT DEFAULT NULL, matricule VARCHAR(50) NOT NULL, sexe VARCHAR(8) NOT NULL, statut_finance VARCHAR(8) NOT NULL, date_naissance DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', date_extrait DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', num_extrait VARCHAR(30) NOT NULL, is_admis TINYINT(1) NOT NULL, is_actif TINYINT(1) NOT NULL, is_handicap TINYINT(1) NOT NULL, nature_handicap VARCHAR(100) DEFAULT NULL, date_inscription DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', date_recrutement DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', adresse VARCHAR(255) NOT NULL, fullname VARCHAR(255) NOT NULL, INDEX IDX_383B09B1C8121CE9 (nom_id), INDEX IDX_383B09B158819F9E (prenom_id), INDEX IDX_383B09B138C8067D (lieu_naissance_id), INDEX IDX_383B09B1F6203804 (statut_id), INDEX IDX_383B09B1CCF9E01E (departement_id), INDEX IDX_383B09B18F5EA509 (classe_id), INDEX IDX_383B09B18D3AF34D (ecole_an_dernier_id), INDEX IDX_383B09B180BDEBFF (ecole_recrutement_id), INDEX IDX_383B09B1F4C45000 (scolarite1_id), INDEX IDX_383B09B1E671FFEE (scolarite2_id), INDEX IDX_383B09B15ECD988B (scolarite3_id), INDEX IDX_383B09B16D13ADFD (redoublement1_id), INDEX IDX_383B09B17FA60213 (redoublement2_id), INDEX IDX_383B09B1C71A6576 (redoublement3_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE users ADD eleves_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE users ADD CONSTRAINT FK_1483A5E9C2140342 FOREIGN KEY (eleves_id) REFERENCES eleves (id)');
        $this->addSql('CREATE INDEX IDX_1483A5E9C2140342 ON users (eleves_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users DROP FOREIGN KEY FK_1483A5E9C2140342');
        ...
        $this->addSql('DROP INDEX IDX_1483A5E9C2140342 ON users');
        $this->addSql('ALTER TABLE users DROP eleves_id');
    }
}
